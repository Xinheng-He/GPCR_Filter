# split-inter
python predict.py \
    --input_data_dir /datapool/data2/home/majianzhu/xinheng/xiangzhen/DTI2/DTI/data/split-target-inter-pure6/test.csv \
...
# split-intra
python predict.py \
    --input_data_dir /datapool/data2/home/majianzhu/xinheng/xiangzhen/DTI2/DTI/data/split-target-intra/test.csv \
